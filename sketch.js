...
var boy,ground,stone,tree,m1,m2,m3,m4,m5,m6,m7,chain,backgroundImage;
...
function setup() {
	...
	m1 = new mango(900,150,10);
	m2 = new mango(950,120,10);
	m3 = new mango(1000,100,10);
	m4 = new mango(950,60,10);
	m5 = new mango(1050,60,10);
